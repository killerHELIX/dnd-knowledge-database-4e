...
GRANT ALL ON character_id_seq, feats_name_seq to dnduser;
...
INSERT INTO feats (name, benefit,) VALUES('Armor Proficiency (Chainmail)', 'Str 13, Con 13, training with leather or hide armor', 'You gain training with chainmail.');
INSERT INTO feats (name, benefit,) VALUES('Armor Proficiency (Chainmail)', 'Str 13, Con 13, training with leather armor', 'You gain training with hide.');
INSERT INTO feats (name, benefit) VALUES('Armor Proficiency (Chainmail)', 'You gain training with leather.');
INSERT INTO feats (name, benefit,) VALUES('Armor Proficiency (Chainmail)', 'Str 13, Con 13, training with scale armor', 'You gain training with plate.');
INSERT INTO feats (name, benefit,) VALUES('Armor Proficiency (Chainmail)', 'Str 15, Con 15, training with chainmail armor', 'You gain training with scale.');
INSERT INTO feats (name, benefit,) VALUES('Astral Fire', 'Dex 13, Cha 13', 'You gain a +1 feat bonus to damage rolls when you use a power that has the fire or radiant keyword. At 11th level, this bonus increases to +2. At 21st level, it increases to +3.');
INSERT INTO feats (name, benefit,) VALUES('Avandra''s Rescue', 'Channel Divinity class feature, must worship Avandra', 'You can invoke the power of your deity to use Avandra''s Rescue. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Backstabber', 'Rogue, Sneak Attack class feature', 'The extra damage dice from your Sneak Attack class feature increase from d6s to d8s.');
INSERT INTO feats (name, benefit,) VALUES('Blade Opportunist', 'Str 13, Dex13', 'You gain a +2 bonus to opportunity attack rolls with a heavy blade or a light blade.');
INSERT INTO feats (name, benefit,) VALUES('Burning Blizzard', 'Int 13, Wis 13', 'You gain a +1 feat bonus to damage rolls when you use a power that has the acid or cold keyword. At 11th level, this bonus increases to +2. At 21st level, it increases to +3.');
INSERT INTO feats (name, benefit,) VALUES('Combat Reflexes', 'Dex 13', 'You gain a +1 bonus to opportunity attack rolls.');
INSERT INTO feats (name, benefit,) VALUES('Corellon''s Grace', 'Channel Divinity class feature, must worship Corellon', 'You can invoke the power of your deity to use Corellon''s grace. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Dark Fury', 'Con 13, Wis 13', 'You gain a +1 feat bonus to damage rolls when you use a power that has the necrotic or psychic keyword. At 11th level, this bonus increases to +2. At 21st level, it increases to +3.');
INSERT INTO feats (name, benefit) VALUES('Defensive Mobility', 'You gain a +2 bonus to AC against opportunity attacks.');
INSERT INTO feats (name, benefit, special) VALUES('Distracting Shield', 'Wis 15, fighter, Combat Challenge class feature', 'If you hit a foe with an attack granted by your Combat Challenge class feature, the target takes a –2 penalty to attack rolls until the start of your next turn.', 'You must have a shield equipped to benefit from this feat.');
INSERT INTO feats (name, benefit,) VALUES('Dodge Giants', 'Dwarf', 'You gain a +1 bonus to AC and Reflex defense against the attacks of Large or larger foes.');
INSERT INTO feats (name, benefit,) VALUES('Dragonborn Frenzy', 'Dragonborn', 'While you are bloodied, you gain a +2 bonus to damage rolls.');
INSERT INTO feats (name, benefit,) VALUES('Dragonborn Senses', 'Dragonborn', 'You gain low-light vision. You gain a +1 feat bonus to Perception checks.');
INSERT INTO feats (name, benefit) VALUES('Durable', 'Increase your number of healing surges by two');
INSERT INTO feats (name, benefit,) VALUES('Dwarven Weapon Training', 'Dwarf', 'You gain proficiency and a +2 feat bonus to damage rolls with axes and hammers.');
INSERT INTO feats (name, benefit,) VALUES('Eladrin Soldier', 'Eladrin', 'You gain proficiency with all spears and a +2 feat bonus to damage rolls with longswords and all spears.');
INSERT INTO feats (name, benefit,) VALUES('Elven Precision', 'Elf, elven accuracy racial power', 'When you use the elven accuracy power, you gain a +2 bonus to the new attack roll.');
INSERT INTO feats (name, benefit,) VALUES('Enlarged Dragon Breath', 'Dragonborn, dragon breath racial power', 'When you use your dragon breath power, you can choose to make it blast 5 instead of blast 3.');
INSERT INTO feats (name, benefit,) VALUES('Escape Artist', 'Trained in Acrobatics', 'You can attempt to escape a grab as a minor action, instead of as a move action. You gain a +2 feat bonus to Acrobatics checks.');
...
INSERT INTO feats (name, benefit,) VALUES('Far Shot', 'Dex 13', 'When you use a projectile weapon such as a bow or a crossbow, increase both the normal range and the long range by 5 squares.');
INSERT INTO feats (name, benefit,) VALUES('Far Throw', 'Str 13', 'When you use a thrown weapon such as a dagger or a javelin, increase both the normal range and the long range by 2 squares.');
INSERT INTO feats (name, benefit,) VALUES('Fast Runner', 'Con 13', 'You gain a +2 bonus to speed when you charge or run.');
INSERT INTO feats (name, benefit,) VALUES('Ferocious Rebuke', 'Tiefling, infernal wrath racial power', 'When you use the infernal wrath power and hit with an attack, you can push the target 1 square in addition to any damage you deal.');
INSERT INTO feats (name, benefit,) VALUES('Group Insight', 'Half-elf', 'You grant allies within 10 squares of you a +1 racial bonus to Insight checks and initiative checks.');
INSERT INTO feats (name, benefit,) VALUES('Halfling Agility', 'Halfling, second chance racial power', 'When you use your halfling second chance ability, the attacker takes a –2 penalty to the new attack roll.');
INSERT INTO feats (name, benefit,) VALUES('Harmony of Erathis', 'Channel Divinity class feature, must worship Erathis', 'You can invoke the power of your deity to use harmony of Erathis. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Healing Hands', 'Paladin, lay on hands power', 'When you use the lay on hands power, the affected ally regains additional hit points equal to your Charisma modifier.');
INSERT INTO feats (name, benefit,) VALUES('Hellfire Blood', 'Tiefling', 'You gain a +1 feat bonus to attack rolls and damage rolls when you use a power that has the fire or fear keyword.');
INSERT INTO feats (name, benefit,) VALUES('Human Perseverance', 'Human', 'You gain a +1 feat bonus to saving throws.');
INSERT INTO feats (name, benefit,) VALUES('Improved Dark One''s Blessing', 'Con 15, warlock, infernal pact', 'Your Dark One’s Blessing now gives you 3 additional temporary hit points.');
INSERT INTO feats (name, benefit,) VALUES('Improved Fate of the Void', 'Con 13 or Cha 13, warlock, star pact', 'Your Fate of the Void grants an additional +1 bonus to the d20 roll.');
INSERT INTO feats (name, benefit) VALUES('Improved Initiative', 'You gain a +4 feat bonus to initiative checks.');
INSERT INTO feats (name, benefit,) VALUES('Improved Misty Step', 'Int 13, warlock, fey pact', 'Misty Step now allows you to teleport an additional 2 squares.');
INSERT INTO feats (name, benefit,) VALUES('Inspired Recovery', 'Warlord, Inspiring Presence class feature', 'When an ally who can see you spends an action point to gain an extra standard action, that ally can roll a saving throw as a free action, adding your Charisma modifier to the roll.');
INSERT INTO feats (name, benefit,) VALUES('Ioun''s Poise', 'Channel Divinity class feature, must worship Ioun', 'ou can invoke the power of your deity to use Ioun''s poise. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Jack of All Trades', 'Int 13', 'You gain a +3 feat bonus to all untrained skill checks.');
INSERT INTO feats (name, benefit,) VALUES('Kord''s Favor', 'Channel Divinity class feature, must worship Kord', 'You can invoke the power of your deity to use Kord''s favor. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Lethal Hunter', 'Ranger, Hunter’s Quarry class feature', 'The extra damage dice from your Hunter’s Quarry class feature increase from d6s to d8s.');
...
INSERT INTO feats (name, benefit,) VALUES('Linguist', 'Int 13', 'Choose three languages. You can now speak, read, and write those languages fluently. Special: You can take this feat more than once. Each time you select this feat, choose three new languages to learn.');
INSERT INTO feats (name, benefit,) VALUES('Long Jumper', 'Trained in Athletics', 'You can make all long jumps as if you had a running start. You also gain a +1 feat bonus to Athletics checks.');
INSERT INTO feats (name, benefit,) VALUES('Lost in the Crowd', 'Halfling', 'You gain a +2 bonus to AC when you are adjacent to at least two enemies larger than you.');
INSERT INTO feats (name, benefit,) VALUES('Melora''s Tide', 'Channel Divinity class feature, must worship Melora', 'You can invoke the power of your deity to use Melora''s tide. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Moradin''s Resolve', 'Channel Divinity class feature, must worship Moradin', 'You can invoke the power of your deity to use Moradin’s resolve. [Power]');
...
INSERT INTO feats (name, benefit,) VALUES('Nimble Blade', 'Dex 15', 'When you attack with a light blade and you have combat advantage, you gain a +1 bonus to attack rolls.');
INSERT INTO feats (name, benefit,) VALUES('Pelor''s Radiance', 'Channel Divinity class feature, must worship Pelor', 'You can invoke the power of your deity to use Pelor''s radiance. [Power]');
INSERT INTO feats (name, benefit, special) VALUES('Potent Challenge', 'Con 15, fighter, Combat Challenge class feature', 'If you hit a foe with an attack granted by your Combat Challenge class feature, add your Constitution modifier to the damage roll.', 'This benefit applies only to attacks made with two-handed weapons.');
INSERT INTO feats (name, benefit,) VALUES('Power Attack', 'Str 15', 'When making a melee attack, you can take a –2 penalty to the attack roll. If the attack hits, you gain a +2 bonus to the damage roll (or a +3 bonus to the damage roll with a two-handed weapon) per tier. The attack penalty remains the same.');
INSERT INTO feats (name, benefit,) VALUES('Powerful Charge', 'Str 13', 'When you charge, you gain a +2 bonus to damage and a +2 bonus to bull rush attempts.');
INSERT INTO feats (name, benefit,) VALUES('Precise Hunter', 'Wis 15, ranger, Hunter’s Quarry class feature', 'When you score a critical hit against the target of your Hunter’s Quarry with a ranged attack, your allies gain a +1 bonus to attack rolls against that target until the start of your next turn.');
INSERT INTO feats (name, benefit,) VALUES('Press the Advantage', 'Cha 15, Rogue', 'If you score a critical hit while you have combat advantage, you gain combat advantage against the target until the end of your next turn.');
INSERT INTO feats (name, benefit,) VALUES('Quick Draw', 'Dex 13', 'You can draw a weapon (or an object stored in a belt pouch, bandolier, or similar container, such as a potion) as part of the same action used to attack with the weapon or use the object. You also gain a +2 feat bonus to initiative checks.');
INSERT INTO feats (name, benefit,) VALUES('Raging Storm', 'Con 13, Dex 13', 'You gain a +1 feat bonus to damage rolls when you use a power that has the lightning or thunder keyword. At 11th level, this bonus increases to +2. At 21st level, it increases to +3.');
INSERT INTO feats (name, benefit,) VALUES('Raven Queen''s Blessing', 'Channel Divinity class feature, must worship the Raven Queen', 'You can invoke the power of your deity to use Raven Queen''s blessing. [Power]');
...
INSERT INTO feats (name, benefit,) VALUES('Sehanine''s Reversal', 'Channel Divinity class feature, must worship Sehanine', 'You can invoke the power of your deity to use Sehanine''s reversal. [Power]');
INSERT INTO feats (name, benefit,) VALUES('Shield Proficiency (Heavy)', 'Str 15, Shield Proficiency (Light)', 'You gain proficiency with heavy shields.');
INSERT INTO feats (name, benefit,) VALUES('Shield Proficiency (Light)', 'Str 13', 'You gain proficiency with light shields.');
INSERT INTO feats (name, benefit, special) VALUES('Shield Push', 'Fighter, Combat Challenge class feature', 'If you hit a foe with an attack granted by your Combat Challenge class feature, you push the target 1 square after dealing damage.', 'You must carry a shield to benefit from this feat.');
INSERT INTO feats (name, benefit, special) VALUES('Skill Focus', 'Training in chose skill', 'Choose a skill in which you have training. You have a +3 feat bonus to checks with that skill.', 'You can take this feat more than once. Each time you select this feat, choose a different skill.');
INSERT INTO feats (name, benefit,) VALUES('Skill Training', 'You gain training in one skill. The skill need not be on your class skill list.', 'You can take this feat more than once. Each time you select this feat, choose a skill in which you are not trained.');
INSERT INTO feats (name, benefit,) VALUES('Sure Climber', 'Trained in Athletics', 'A successful Athletics check allows you to climb at your normal speed, rather than half speed. You also gain a +1 feat bonus to Athletics checks.');
INSERT INTO feats (name, benefit,) VALUES('Surprise Knockdown', 'Str 15, rogue', 'If you score a critical hit while you have combat advantage, you knock the target prone.');
INSERT INTO feats (name, benefit,) VALUES('Tactical Assault', 'Warlord, Tactical Presence class feature', 'When an ally who can see you spends an action point to make an attack, the attack’s damage roll gains a bonus equal to your Intelligence modifier.');
...
INSERT INTO feats (name, benefit,) VALUES('Two-Weapon Defense', 'Dex 13, Two-Weapon Fighting', 'While holding a melee weapon in each hand, you gain a +1 shield bonus to AC and Reflex.');
INSERT INTO feats (name, benefit,) VALUES('Two-Weapon Fighting', 'Dex 13', 'While holding a melee weapon in each hand, you gain a +1 bonus to damage rolls with your main weapon.');
