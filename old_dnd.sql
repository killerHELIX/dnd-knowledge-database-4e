...
INSERT INTO powers (name, origin, flavor, keywords, actiontype, range, effect, special) 
VALUES ('Channel Divinity: Moradin''s Resolve','Feat', 'Moradin''s  blessing puts the small on more equal footing with the large', 'Divine', 'Minor Action', 'Personal', 'You or one Ally; bloodied target only', 'The target gains regeneration 2, per tier, until the end of the encounter or until he or she is no longer bloodied.', 'You must take the Melora''s Tide feat to use this power');
